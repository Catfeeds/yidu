...
$arr['optionshtml'] = '<select name="cat_id_'. $divid .'" size=8 style="float:left;display:inline;margin-left:3px;" onchange="catsel(this, '. $divid .')"><option value="0" style="background:#dce6f0;">请选择&nbsp;&nbsp;&nbsp;&nbsp;</option>'. $option_temp .'</select><div id="catsel'. $divid_next .'" style="float:left;display:inline;margin-left:3px;"></div>';
...

    {
...

        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral,exclusive, supplier_id,supplier_status,cost_price,stock_right)" .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral','$exclusive', '$supplier_id', '0', '$cost_price', '$stock_right')";
...

        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code,exclusive, rank_integral, supplier_status, cost_price, stock_right)" .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code','$exclusive', '$rank_integral','0','$cost_price', '$stock_right')";
