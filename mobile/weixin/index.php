...
if ($event['event'] == "CLICK"){
	...
	switch($content){
		...
		case "refund":
			...
			$text = "请在“个人中心”找到相应订单，在订单详情页点击“申请退款”即可申请退款。如果遇到商品相关问题需要联系易度客服，请拨打400-830-1680。";
		...
		case "contat":
			...
			$text = "出现商品问题时，请点击“个人中心”找到相应订单，进入订单详情页中找到商铺主页，点击商铺介绍后，即可与商家客服取得联系。";
		...
		case "suggest":
			...
			$text = "亲，很抱歉，这次没有让您得到一个好的购物体验，如果您有任何问题，请拨打我们的客服热线400-830-1680，客服人员会为您马上处理。";
...
if($content){
	...
	//wenjun start 2018-06-13
	if($content == '1' || $content == '签到'){

		
		echo $weixin->image()->reply();exit;
	}
