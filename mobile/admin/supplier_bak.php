...
elseif ($_REQUEST['act']== 'edit')
{
    ...
    // 所有拥有店铺的代理商
    $sql = "SELECT a.shop_id, a.shop_code, a.agent_id, b.user_name FROM " . $ecs->table('agent_shop') . " a LEFT JOIN " . $ecs->table('users') . " b ON a.agent_id = b.user_id WHERE chuzu_status = 0 ORDER BY add_time DESC";
