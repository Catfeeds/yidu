...
//wenjun start
$_LANG['use_integral'] = '使用购物币';
$_LANG['can_use_integral'] = '您当前的可用购物币为';
//wenjun end
...
$_LANG['p_y']['link_start'] = '<a href="http://www.hunuo.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
