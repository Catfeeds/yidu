...
//                    }
    ...
    if ($order['order_amount'] > 0)
    {
        ...
        if ($order['pay_id'] == 1) {
             /* 进入支付页面 */
            // ecs_header("Location: ./pay/alipayapi.php?out_trade_no=$order[log_id]&total_fee=$order[order_amount]&flag=1\n");
        ...
        if ($order['pay_id'] == 7) {
             /* 进入支付页面 */
            // ecs_header("Location: ./weixinpay.php?out_trade_no=$order[log_id]&flag=1\n");
