...

{
    ...
    $shopbanner = empty($GLOBALS['_CFG']['shop_header_text']) ? 'themes/'.$GLOBALS['_CFG']['template'].'/images/shop_banner.jpg' :trim($GLOBALS['_CFG']['shop_header_text']);
    
    $smarty->assign('shoplogo',        $shoplogo);//商家logo

    $smarty->assign('shopbanner',      $shopbanner);//商家Banner
