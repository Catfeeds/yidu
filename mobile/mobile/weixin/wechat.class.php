...

{
	...
	*/
	...
	public function image($text='')
	{
        ...
        $msgType = "image"; //消息类型
        $contentStr = 'pSMyRV_CCpnkoZiJAA8PAVEVyGLSYIM07Jq0ob3La9tTu5apK_pssmHeEtz6EqC7'; //返回消息内容

        //格式化消息模板
        $resultStr = sprintf($textTpl,$this->getRevFrom(),$this->getRevTo(),time(),$msgType,$contentStr);
        echo $resultStr; //输出结果
	}
