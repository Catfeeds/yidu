...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['ads_add'], 'href' => 'mads.php?act=add'));
...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('mads_list.htm'), '',
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('action_link',   array('href' => 'mads.php?act=list', 'text' => $_LANG['ad_list']));
    $smarty->assign('position_list', get_mposition_list());
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $link[1]['href'] = 'mads.php?act=list';

    $link[2]['text'] = $_LANG['continue_add_ad'];
    $link[2]['href'] = 'mads.php?act=add';
...
elseif ($_REQUEST['act'] == 'update')
{
   ...
   /* 提示信息 */
   $href[] = array('text' => $_LANG['back_ads_list'], 'href' => 'mads.php?act=list');
...
elseif ($_REQUEST['act'] == 'remove')
{
    ...
    $url = 'mads.php?act=query&' . str_replace('act=remove', '', $_SERVER['QUERY_STRING']);
