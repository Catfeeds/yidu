...
// $modules['02_cat_and_goods']['02_shop_goods_apply_list'] = 'shop.php?act=apply_list'; // 店铺商品申请列表
...
$modules['05_banner']['mad_position'] = 'mad_position.php?act=list';

$modules['05_banner']['mad_list'] = 'mads.php?act=list';
...
$modules['08_agent']['01_agent_apply_list'] = 'agent.php?act=apply_list';

$modules['08_agent']['02_factory_apply_list'] = 'factory.php?act=apply_list';

$modules['08_agent']['03_agent_add'] = 'agent.php?act=add';
...
$modules['08_members']['09_user_recharge'] = 'user_recharge.php?act=list';
...
$modules['08_members']['10_mail_list'] = 'mail.php?act=list';
...
$modules['11_system']['02_mobile_menu'] = 'mobile_menu.php?act=list';//手机端自定义菜单
...
$modules['11_system']['bank_manage'] = 'bank_manage.php?act=list';
...
$modules['15_rec']['ex_affiliate_ck'] = 'ex_affiliate_ck.php?act=list';	//抽奖分成管理
...
$modules['02_supplier']['activity_apply_list'] = 'activity_apply.php?act=apply_list';
