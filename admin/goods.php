...

{
    ...
    $factory_list_name = factory_list_name();

    $factory_exists = 1;

    if (empty($factory_list_name))
    ...
    $smarty->assign('factory_exists', $factory_exists);

    $smarty->assign('factory_list_name', $factory_list_name);

    unset($factory_list_name, $factory_exists);
...

{
    ...
    $give_integral = isset($_POST['give_integral']) ? intval($_POST['give_integral']) : '0';    //henson edit
	...
	$stock_right = !empty($_POST['stock_right']) ? $_POST['stock_right'] : 0;
...

    {
...

        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral,exclusive, suppliers_id, cost_price, factory_id, stock_right)" .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral','$exclusive', '$suppliers_id', '$cost_price', '$factory_id', '$stock_right')";
...

        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code,exclusive, rank_integral, cost_price, stock_right)" .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code','$exclusive', '$rank_integral', '$cost_price', '$stock_right')";
	...
	/* 代码增加_start    为了便于新手朋友修改，这里采用增加代码的方法来修改，没有采用修改代码的方法 */
...

{
    ...
    $sql = "SELECT goods_id, goods_name, is_delete, is_real, goods_thumb, goods_desc, " .
	...
	$domain_hunuo_com = $ecs->get_domain();

	$fullurl_hunuo_com = $ecs->url();

	$mainurl_hunuo_com = str_replace($domain_hunuo_com, "", $fullurl_hunuo_com);

	$mainurl_hunuo_com = str_replace("/", "\/", $mainurl_hunuo_com);

	//echo $mainurl_hunuo_com;
	...
	foreach ($DesImgs[1] AS $img_del_hunuo_com)

	{

		//echo $img_del_hunuo_com."<br />";

		//$final_img_del_hunuo_com = preg_replace("/". $mainurl_hunuo_com ."/i", "../", $img_del_hunuo_com, 1);

		//echo $final_img_del_hunuo_com."<br />";

		//删除商品描述的图片

		$stt = explode('../../',$img_del_hunuo_com);
	...
	//	@unlink($final_img_del_hunuo_com);
