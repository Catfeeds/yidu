...
class cls_session
{
    ...
    var $max_life_time  = 2592000; // SESSION 杩囨湡鏃堕棿 1800
    ...
    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'ECS_ID', $session_id = '')
    {
        ...
        if ($session_id == '' && !empty($_POST[$this->session_name]))
        {
            $this->session_id = $_POST[$this->session_name];
        }
        else
        {
