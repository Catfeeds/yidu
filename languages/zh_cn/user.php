...
$_LANG['withdraw_balance'] = '提现余额';
$_LANG['money'] = '金额';
$_LANG['available_balance'] = '可用余额';
$_LANG['locking_balance'] = '锁定余额';
...
$_LANG['mobile_code_template'] = '您本次验证码为%s请在10分钟内使用！';//短信验证码模版
// $_LANG['mobile_virtual_template'] = '【%s】提示：感谢您购买 【%s】 您的验证码为 %s 请在 %s 之前使用，谢谢合作。';//虚拟团购验证码发送模板
$_LANG['mobile_virtual_template'] = '您本次验证码为%s请在10分钟内使用！';//虚拟团购验证码发送模板
/* 用户中心默认页面 */
