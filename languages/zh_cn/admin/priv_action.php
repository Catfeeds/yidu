...
$_LANG['shop_goods_apply_list'] = '店铺商品申请列表';
...
$_LANG['user_account_recharge'] = '购物币充值';
$_LANG['account_manage'] = '会员账户管理';
$_LANG['mail_list'] = '站内信';

// 业主管理权限
$_LANG['agent_apply_list'] = '业主申请列表';
$_LANG['factory_apply_list'] = '厂家申请列表';
