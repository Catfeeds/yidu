...
$_LANG['lab_integral'] = '购物币购买金额：';
$_LANG['lab_give_integral'] = '赠送消费购物币数：';
$_LANG['lab_rank_integral'] = '赠送等级购物币数：';
...
$_LANG['notice_integral'] = '(此处需填写金额)购买该商品时最多可以使用购物币的金额';
$_LANG['notice_give_integral'] = '购买该商品时赠送消费购物币数,-1表示按商品价格赠送';
$_LANG['notice_rank_integral'] = '购买该商品时赠送等级购物币数,-1表示按商品价格赠送';
