...
$_LANG['cfg_name']['shop_banner'] = '商店 Banner';
...
$_LANG['cfg_desc']['shop_logo'] = '请上传1:1尺寸比例的图片，在上传前将图片的文件名命名为logo.gif';
$_LANG['cfg_desc']['shop_banner'] = 'Banner最佳尺寸为658px X 188px';
...
$_LANG['cfg_desc']['email_domain'] = '提示：域名之间用“，”隔开（逗号不分全角、半角），域名无须带www<br>参照样式：163.com,baidu.com,sina.com';
...
$_LANG['cfg_name']['agent'] = '业主设置';
$_LANG['cfg_name']['agent_shop_cost_c'] = '创业型业主店铺管理费(元/季/店)';
$_LANG['cfg_name']['agent_shop_cost_x'] = '小型业主店铺管理费(元/季/店)';
$_LANG['cfg_name']['agent_shop_cost_z'] = '中型业主店铺管理费(元/季/店)';
$_LANG['cfg_name']['agent_shop_cost_d'] = '大型业主店铺管理费(元/季/店)';
$_LANG['cfg_name']['agent_shop_cost_v'] = 'VIP业主店铺管理费(元/季/店)';
$_LANG['cfg_name']['shop_renter_cost'] = '店铺租金(元/季/店)';
$_LANG['cfg_name']['agent_shop_num_c'] = '创业型业主店铺数量(个)';
$_LANG['cfg_name']['agent_shop_num_x'] = '小型业主店铺数量(个)';
$_LANG['cfg_name']['agent_shop_num_z'] = '中型业主店铺数量(个)';
$_LANG['cfg_name']['agent_shop_num_d'] = '大型业主店铺数量(个)';
$_LANG['cfg_name']['agent_shop_num_v'] = 'VIP业主店铺数量(个)';
$_LANG['cfg_name']['agent_zs_cost_c'] = '创业型业主终身业主费(元/季)';
$_LANG['cfg_name']['agent_zs_cost_x'] = '小型业主终身业主费(元/季)';
$_LANG['cfg_name']['agent_zs_cost_z'] = '中型业主终身业主费(元/季)';
$_LANG['cfg_name']['agent_zs_cost_d'] = '大型业主终身业主费(元/季)';
$_LANG['cfg_name']['agent_zs_cost_v'] = 'VIP业主终身业主费(元/季)';

$_LANG['cfg_name']['reward'] = '奖励设置';
$_LANG['cfg_name']['rebate_per'] = '会员购物返利百分比（%）';
$_LANG['cfg_name']['recommend_rebate_per'] = '推荐区商品购买业主奖励百分比（%）';
$_LANG['cfg_name']['quarter_bonus'] = '会员季度分红百分比（%）';
$_LANG['cfg_name']['quarter_bonus_cost'] = '季度消费分红条件（元）';
$_LANG['cfg_name']['reward_level_1'] = '一级业主佣金（元）';
$_LANG['cfg_name']['reward_level_2'] = '二级业主佣金（元）';
$_LANG['cfg_name']['reward_level_3'] = '三级业主佣金（元）';
